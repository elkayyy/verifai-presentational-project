...
const modifyCountryWhite = (whiteList: string[]) => {
    fetch("/modifyCountryWhiteList", {
        method: "POST",
        headers: {
...
const FlagTypes = (props: Partial<MultiSelectProps>) => {

  const [countryWhiteList, setcountryWhiteList] = useState([]);
  return (

    <div className="main-Document-Countries" > {/* Countries search Box */}
      <div className='innerMain-Container'>

        <div className='labelContainer'>
          <h4 className='label'> Whitelist Countries <FaRegFlag size={15} /> </h4>
        </div>
      ...
      <div className='MultiSelect'>
        <MultiSelect
          ...
          styles={{
            label: { fontSize: "20px", paddingInline: "1%" }
          }}
          onChange={setcountryWhiteList}
          onDropdownClose={()=>modifyCountryWhite(countryWhiteList)}
